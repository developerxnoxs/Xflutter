...
abstract class Route<X0> extends _RoutePlaceholder {
  ...
  get _ isFirst(/* No info */) {
    ...
    //     0x40d844: ldr             x2, [PP, #0x7848]  ; [pp+0x7848] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7f72c5613ffc)
...
class NavigatorState extends _NavigatorState&State&TickerProviderStateMixin&RestorationMixin {
  ...
  _ _flushHistoryUpdates(/* No info */) {
    ...
    //     0x409b34: ldr             x3, [PP, #0x7848]  ; [pp+0x7848] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7f72c5613ffc)
    ...
    //     0x409d44: ldr             x3, [PP, #0x7848]  ; [pp+0x7848] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7f72c5613ffc)
    ...
    //     0x409e78: ldr             x3, [PP, #0x7860]  ; [pp+0x7860] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7f72c5613fc4)
    ...
    //     0x409f34: ldr             x3, [PP, #0x7860]  ; [pp+0x7860] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7f72c5613fc4)
    ...
    //     0x40a0c4: ldr             x3, [PP, #0x7860]  ; [pp+0x7860] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7f72c5613fc4)
  ...
  _ _flushRouteAnnouncement(/* No info */) {
    ...
    //     0x40ca48: ldr             x3, [PP, #0x7938]  ; [pp+0x7938] Closure: (_RouteEntry) => bool from Function 'suitableForTransitionAnimationPredicate': static. (0x7f72c560cce4)
  ...
  _ canPop(/* No info */) {
    ...
    //     0x68eda8: ldr             x2, [PP, #0x7848]  ; [pp+0x7848] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7f72c5613ffc)
    // 0x68edac: r0 = where()
  ...
  _ _recordLastFocus(/* No info */) {
    ...
    //     0x68ef2c: ldr             x2, [PP, #0x7848]  ; [pp+0x7848] Closure: (_RouteEntry) => bool from Function 'isPresentPredicate': static. (0x7f72c5613ffc)
    // 0x68ef30: r0 = where()
  ...
  _ didStartUserGesture(/* No info */) {
    ...
    //     0x8442b8: ldr             x3, [PP, #0x7860]  ; [pp+0x7860] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7f72c5613fc4)
    ...
    //     0x844334: ldr             x3, [PP, #0x7860]  ; [pp+0x7860] Closure: (_RouteEntry) => bool from Function 'willBePresentPredicate': static. (0x7f72c5613fc4)
