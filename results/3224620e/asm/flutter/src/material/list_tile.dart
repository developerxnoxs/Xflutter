...
class _RenderListTile extends __RenderListTile&RenderBox&SlottedContainerRenderObjectMixin {
  ...
  _ computeDryBaseline(/* No info */) {
    ...
    //     0x599e10: add             x2, PP, #0x23, lsl #12  ; [pp+0x23498] Closure: (RenderBox, BoxConstraints, TextBaseline) => double? from Function 'getDryBaseline': static. (0x7f72c573e1ac)
    //     0x599e14: ldr             x2, [x2, #0x498]
    // 0x599e18: r3 = Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static.
    //     0x599e18: add             x3, PP, #0x23, lsl #12  ; [pp+0x233e8] Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static. (0x7f72c574dc60)
  ...
  _ computeDryLayout(/* No info */) {
    ...
    //     0x5a26f0: add             x2, PP, #0x23, lsl #12  ; [pp+0x23498] Closure: (RenderBox, BoxConstraints, TextBaseline) => double? from Function 'getDryBaseline': static. (0x7f72c573e1ac)
    //     0x5a26f4: ldr             x2, [x2, #0x498]
    // 0x5a26f8: r3 = Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static.
    //     0x5a26f8: add             x3, PP, #0x23, lsl #12  ; [pp+0x233e8] Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static. (0x7f72c574dc60)
  ...
  _ performLayout(/* No info */) {
    ...
    //     0x62edb4: add             x16, PP, #0x2b, lsl #12  ; [pp+0x2b958] Closure: (RenderBox, Offset) => void from Function '_positionBox@134247952': static. (0x7f72c579a82c)
    ...
    //     0x62edc8: add             x2, PP, #0x21, lsl #12  ; [pp+0x21460] Closure: (RenderBox, BoxConstraints, TextBaseline) => double? from Function 'getBaseline': static. (0x7f72c582ed08)
    //     0x62edcc: ldr             x2, [x2, #0x460]
    // 0x62edd0: r3 = Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static.
    //     0x62edd0: add             x3, PP, #0x20, lsl #12  ; [pp+0x20fd0] Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static. (0x7f72c57a13f8)
