...
class CupertinoTextFormFieldRow extends FormField<dynamic> {
  ...
  [closure] CupertinoFormRow <anonymous closure>(dynamic, FormFieldState<String>) {
    ...
    //     0x8a9698: add             x2, PP, #0x3f, lsl #12  ; [pp+0x3ff08] Closure: (BuildContext, EditableTextState) => Widget from Function '_defaultContextMenuBuilder@489379695': static. (0x7f72c594d47c)
