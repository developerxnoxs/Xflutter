...
class AppLovinAdNetwork extends AdNetwork {
  ...
  _ initialize(/* No info */) async {
    ...
    //     0x5688f4: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7f72c55d890c)
  ...
  [closure] Null <anonymous closure>(dynamic, String, MaxError) {
    ...
    //     0x56d65c: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7f72c55d890c)
  ...
  _ loadAdInternal(/* No info */) async {
    ...
    //     0x56de50: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7f72c55d890c)
