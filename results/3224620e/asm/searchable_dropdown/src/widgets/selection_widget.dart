...
class SelectionWidgetState<C1X0> extends State<C1X0> {
  ...
  _ _searchField(/* No info */) {
    ...
    //     0x795658: add             x0, PP, #0x12, lsl #12  ; [pp+0x124c8] Closure: (BuildContext, EditableTextState) => Widget from Function '_defaultContextMenuBuilder@181181401': static. (0x7f72c577fc10)
  ...
  [closure] Widget <anonymous closure>(dynamic, BuildContext, AsyncSnapshot<List<C1X0>>) {
    ...
    //     0x795968: add             x1, PP, #0x38, lsl #12  ; [pp+0x38678] Closure: (ScrollNotification) => bool from Function 'defaultScrollNotificationPredicate': static. (0x7f72c58fd728)
