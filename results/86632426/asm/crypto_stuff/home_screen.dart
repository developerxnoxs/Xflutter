...
class :: {
  ...
  static HomeScreenPage WALLET_HOME_SCREEN_PAGE() {
    ...
    //     0x57735c: add             x1, PP, #0x10, lsl #12  ; [pp+0x102e8] Closure: () => Widget from Function 'walletScreenCreator': static. (0x7fd76f977374)
  ...
  static HomeScreenPage EARN_MORE_HOME_SCREEN_PAGE() {
    ...
    //     0x57741c: add             x1, PP, #0x10, lsl #12  ; [pp+0x10300] Closure: () => Widget from Function 'earnMoreScreenCreator': static. (0x7fd76f977434)
