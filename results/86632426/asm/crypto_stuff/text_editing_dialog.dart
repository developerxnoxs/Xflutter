...
abstract class TextEditingDialog extends Object {
  ...
  [closure] static Container <anonymous closure>(dynamic, BuildContext, Widget?) {
    ...
    //     0x57f494: add             x1, PP, #0x12, lsl #12  ; [pp+0x124c8] Closure: (BuildContext, EditableTextState) => Widget from Function '_defaultContextMenuBuilder@181181401': static. (0x7fd76f97fc10)
