...
class _WidgetsAppState extends __WidgetsAppState&State&WidgetsBindingObserver {
  ...
  _ build(/* No info */) {
    ...
    //     0x778da8: add             x0, PP, #0x2f, lsl #12  ; [pp+0x2ff60] Closure: (NavigatorState, String) => List<Route<dynamic>> from Function 'defaultGenerateInitialRoutes': static. (0x7fd76fb79c90)
    ...
    //     0x779004: ldr             x0, [PP, #0x5580]  ; [pp+0x5580] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7fd76f870824)
