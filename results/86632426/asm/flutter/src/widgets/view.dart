...
class _ViewState extends __ViewState&State&WidgetsBindingObserver {
  ...
  _ _ViewState(/* No info */) {
    ...
    //     0x80dffc: ldr             x1, [PP, #0x5580]  ; [pp+0x5580] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7fd76f870824)
