...
class :: {
  ...
  static _ startListeningToUDL(/* No info */) async {
    ...
    //     0x654f5c: add             x2, PP, #0x1e, lsl #12  ; [pp+0x1e718] Closure: (MethodCall) => Future<void> from Function '_methodCallHandler@529413402': static. (0x7fd76fa5508c)
  ...
  static _ startListening(/* No info */) async {
    ...
    //     0x655c7c: add             x2, PP, #0x1e, lsl #12  ; [pp+0x1e718] Closure: (MethodCall) => Future<void> from Function '_methodCallHandler@529413402': static. (0x7fd76fa5508c)
