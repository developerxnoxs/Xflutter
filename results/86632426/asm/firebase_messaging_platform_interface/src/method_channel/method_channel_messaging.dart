...
class MethodChannelFirebaseMessaging extends FirebaseMessagingPlatform {
  ...
  _ registerBackgroundMessageHandler(/* No info */) async {
    ...
    //     0x5644f8: add             x1, PP, #0x11, lsl #12  ; [pp+0x117b0] Closure: () => void from Function '_firebaseMessagingCallbackDispatcher@1011184891': static. (0x7fd76f8961d8)
    ...
    //     0x564510: add             x1, PP, #0x11, lsl #12  ; [pp+0x117a8] Closure: (RemoteMessage) => Future<void> from Function '_firebaseMessagingBackgroundHandler@570043293': static. (0x7fd76f8d2598)
