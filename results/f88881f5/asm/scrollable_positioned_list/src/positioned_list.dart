...
class _PositionedListState extends State<dynamic> {
  ...
  _ build(/* No info */) {
    ...
    //     0x792a38: add             x3, PP, #0x25, lsl #12  ; [pp+0x25490] Closure: (Widget, int) => int from Function '_kDefaultSemanticIndexCallback@282070758': static. (0x7fb6ec771cec)
    ...
    //     0x792b80: add             x3, PP, #0x25, lsl #12  ; [pp+0x25490] Closure: (Widget, int) => int from Function '_kDefaultSemanticIndexCallback@282070758': static. (0x7fb6ec771cec)
    ...
    //     0x792cfc: add             x1, PP, #0x25, lsl #12  ; [pp+0x25490] Closure: (Widget, int) => int from Function '_kDefaultSemanticIndexCallback@282070758': static. (0x7fb6ec771cec)
