...
class :: {
  ...
  [closure] static Future<void> collectStoreCountry(dynamic) async {
    ...
    //     0x661fc4: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7fb6ec1d890c)
  ...
  [closure] static Future<void> collectDeviceInfo(dynamic) async {
    ...
    //     0x6622e4: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7fb6ec1d890c)
