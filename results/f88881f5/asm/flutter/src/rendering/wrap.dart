...
class RenderWrap extends _RenderWrap&RenderBox&ContainerRenderObjectMixin&RenderBoxContainerDefaultsMixin {
  ...
  _ computeDryBaseline(/* No info */) {
    ...
    //     0x59c3ec: add             x3, PP, #0x23, lsl #12  ; [pp+0x233e8] Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static. (0x7fb6ec34dc60)
  ...
  _ performLayout(/* No info */) {
    ...
    //     0x63517c: add             x3, PP, #0x20, lsl #12  ; [pp+0x20fd0] Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static. (0x7fb6ec3a13f8)
    ...
    //     0x6352a4: add             x6, PP, #0x26, lsl #12  ; [pp+0x26ed8] Closure: (Offset, RenderBox) => void from Function '_setChildPosition@371302920': static. (0x7fb6ec435388)
    //     0x6352a8: ldr             x6, [x6, #0xed8]
    // 0x6352ac: r7 = Closure: (RenderBox) => Size from Function '_getChildSize@371302920': static.
    //     0x6352ac: add             x7, PP, #0x26, lsl #12  ; [pp+0x26ee0] Closure: (RenderBox) => Size from Function '_getChildSize@371302920': static. (0x7fb6ec435358)
