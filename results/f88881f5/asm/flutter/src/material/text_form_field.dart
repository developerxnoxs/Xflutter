...
class TextFormField extends FormField<dynamic> {
  ...
  [closure] UnmanagedRestorationScope <anonymous closure>(dynamic, FormFieldState<String>) {
    ...
    //     0x8aaf48: add             x2, PP, #0x3f, lsl #12  ; [pp+0x3fe50] Closure: (BuildContext, EditableTextState) => Widget from Function '_defaultContextMenuBuilder@182147271': static. (0x7fb6ec6aafb4)
