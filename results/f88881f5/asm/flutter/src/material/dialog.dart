...
class DialogRoute<X0> extends RawDialogRoute<X0> {
  ...
  _ DialogRoute(/* No info */) {
    ...
    //     0x55f9c0: add             x6, PP, #0x12, lsl #12  ; [pp+0x12f98] Closure: (BuildContext, Animation<double>, Animation<double>, Widget) => Widget from Function '_buildMaterialDialogTransitions@106506021': static. (0x7fb6ec771cec)
