...
abstract class FocusTraversalPolicy extends _DiagnosticableTree&Object&Diagnosticable {
  ...
  static _ _findGroups(/* No info */) {
    ...
    //     0x470094: ldr             x0, [PP, #0x5580]  ; [pp+0x5580] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7fb6ec270824)
    ...
    //     0x47039c: ldr             x2, [PP, #0x4b68]  ; [pp+0x4b68] Closure: (FocusNode) => bool from Function '_allowDescendantsToBeFocused@233042876': static. (0x7fb6ec25d548)
    // 0x4703a0: r0 = every()
...
class FocusTraversalGroup extends StatefulWidget {
  ...
  _ FocusTraversalGroup(/* No info */) {
    ...
    //     0x779284: ldr             x1, [PP, #0x5580]  ; [pp+0x5580] Closure: (FocusNode, {ScrollPositionAlignmentPolicy? alignmentPolicy, double? alignment, Duration? duration, Curve? curve}) => void from Function 'defaultTraversalRequestFocusCallback': static. (0x7fb6ec270824)
