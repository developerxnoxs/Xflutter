...
class CupertinoAdaptiveTextSelectionToolbar extends StatelessWidget {
  ...
  _ build(/* No info */) {
    ...
    //     0x7f5a34: add             x1, PP, #0x22, lsl #12  ; [pp+0x22790] Closure: (BuildContext, Offset, Offset, Widget) => Widget from Function '_defaultToolbarBuilder@491408280': static. (0x7fb6ec54dd5c)
