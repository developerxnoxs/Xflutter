...
class CupertinoPageRoute<X0> extends _CupertinoPageRoute&PageRoute&CupertinoRouteTransitionMixin<X0> {
  ...
  get _ delegatedTransition(/* No info */) {
    ...
    //     0x9514c8: add             x0, PP, #0x1a, lsl #12  ; [pp+0x1ab88] Closure: (BuildContext, Animation<double>, Animation<double>, bool, Widget?) => Widget? from Function 'delegatedTransition': static. (0x7fb6ec7514d4)
