...
class _CupertinoTextFieldState extends __CupertinoTextFieldState&State&RestorationMixin&AutomaticKeepAliveClientMixin
  ...
  _ build(/* No info */) {
    ...
    //     0x74a42c: add             x16, PP, #0x3f, lsl #12  ; [pp+0x3ff08] Closure: (BuildContext, EditableTextState) => Widget from Function '_defaultContextMenuBuilder@489379695': static. (0x7fb6ec54d47c)
