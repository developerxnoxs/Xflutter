...
class XmlEventParser extends Object {
  ...
  _ event(/* No info */) {
    ...
    //     0x518de4: add             x16, PP, #0x3d, lsl #12  ; [pp+0x3d638] Closure: (Failure, Failure) => Failure from Function 'selectFarthest': static. (0x7fb6ec319248)
  ...
  _ startElement(/* No info */) {
    ...
    //     0x51e284: add             x16, PP, #0x3d, lsl #12  ; [pp+0x3db78] Closure: (Failure, Failure) => Failure from Function 'selectFirst': static. (0x7fb6ec31a5c4)
