...
class _AddLoginScreenState extends State<dynamic> {
  ...
  _ addLogin(/* No info */) async {
    ...
    //     0x64fdf8: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7f3e6b7d890c)
  ...
  [closure] void <anonymous closure>(dynamic, BuildContext, AuthFailed) {
    ...
    //     0x6d92fc: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7f3e6b7d890c)
