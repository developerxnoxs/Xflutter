...
abstract class SvgLoader<X0> extends BytesLoader {
  ...
  [closure] Future<ByteData> <anonymous closure>(dynamic, X0?) {
    ...
    //     0x7a72bc: add             lr, PP, #0x3c, lsl #12  ; [pp+0x3c980] Closure: <Y0, Y1>((Y0) => FutureOr<Y1>, Y0, {String? debugLabel}) => Future<Y1> from Function 'compute': static. (0x7f3e6b8413e4)
    ...
    //     0x7a72dc: add             x0, PP, #0x3c, lsl #12  ; [pp+0x3c980] Closure: <Y0, Y1>((Y0) => FutureOr<Y1>, Y0, {String? debugLabel}) => Future<Y1> from Function 'compute': static. (0x7f3e6b8413e4)
