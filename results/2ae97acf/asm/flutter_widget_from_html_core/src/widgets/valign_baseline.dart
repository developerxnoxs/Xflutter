...
class _ValignBaselineRenderObject extends RenderProxyBox {
  ...
  _ computeDryLayout(/* No info */) {
    ...
    //     0x5a043c: add             x5, PP, #0x23, lsl #12  ; [pp+0x233e8] Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static. (0x7f3e6b94dc60)
  ...
  _ performLayout(/* No info */) {
    ...
    //     0x625698: add             x5, PP, #0x20, lsl #12  ; [pp+0x20fd0] Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static. (0x7f3e6b9a13f8)
