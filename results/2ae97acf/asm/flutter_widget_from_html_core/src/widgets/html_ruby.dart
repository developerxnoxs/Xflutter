...
class _RubyRenderObject extends __RubyRenderObject&RenderBox&ContainerRenderObjectMixin&RenderBoxContainerDefaultsMixin {
  ...
  _ computeDryLayout(/* No info */) {
    ...
    //     0x5a3be8: add             x3, PP, #0x23, lsl #12  ; [pp+0x233e8] Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static. (0x7f3e6b94dc60)
  ...
  _ performLayout(/* No info */) {
    ...
    //     0x636114: add             x3, PP, #0x20, lsl #12  ; [pp+0x20fd0] Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static. (0x7f3e6b9a13f8)
