...
class ForcePressGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  _ ForcePressGestureRecognizer(/* No info */) {
    ...
    //     0x789edc: add             x0, PP, #0x27, lsl #12  ; [pp+0x27618] Closure: (double, double, double) => double from Function '_inverseLerp@57518508': static. (0x7f3e6b921fbc)
    ...
    //     0x789f0c: add             x16, PP, #0x12, lsl #12  ; [pp+0x12b10] Closure: (int) => bool from Function '_defaultButtonAcceptBehavior@66296176': static. (0x7f3e6bd661c4)
