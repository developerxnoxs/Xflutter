...
class TextPainter extends Object {
  ...
  _ _computeCaretMetrics(/* No info */) {
    ...
    //     0x456a70: ldr             x3, [PP, #0x3238]  ; [pp+0x3238] Closure: (double, double, double, double, int, int, bool) => GlyphInfo from Function 'GlyphInfo._@17065589': static. (0x7f3e6b857f60)
    ...
    //     0x456acc: ldr             x3, [PP, #0x3240]  ; [pp+0x3240] Closure: (bool, double, double, double, double, double, double, double, int) => LineMetrics from Function 'LineMetrics._@17065589': static. (0x7f3e6b857ea8)
...
class _TextLayout extends Object {
  ...
  _LineCaretMetrics _computeEndOfTextCaretAnchorOffset(_TextLayout) {
    ...
    //     0x457bc8: ldr             x3, [PP, #0x3240]  ; [pp+0x3240] Closure: (bool, double, double, double, double, double, double, double, int) => LineMetrics from Function 'LineMetrics._@17065589': static. (0x7f3e6b857ea8)
    ...
    //     0x457d14: ldr             x3, [PP, #0x3238]  ; [pp+0x3238] Closure: (double, double, double, double, int, int, bool) => GlyphInfo from Function 'GlyphInfo._@17065589': static. (0x7f3e6b857f60)
