...
class RenderConstraintsTransformBox extends _RenderConstraintsTransformBox&RenderAligningShiftedBox&DebugOverflowIndicatorMixin {
  ...
  _ RenderConstraintsTransformBox(/* No info */) {
    ...
    //     0x7ccdc0: add             x0, PP, #0x39, lsl #12  ; [pp+0x39578] Closure: (BoxConstraints) => BoxConstraints from Function 'transform': static. (0x7f3e6b938fd0)
  ...
  set _ constraintsTransform=(/* No info */) {
    ...
    //     0x7da158: add             x16, PP, #0x39, lsl #12  ; [pp+0x39578] Closure: (BoxConstraints) => BoxConstraints from Function 'transform': static. (0x7f3e6b938fd0)
    //     0x7da15c: ldr             x16, [x16, #0x578]
    // 0x7da160: r30 = Closure: (BoxConstraints) => BoxConstraints from Function 'transform': static.
    //     0x7da160: add             lr, PP, #0x39, lsl #12  ; [pp+0x39578] Closure: (BoxConstraints) => BoxConstraints from Function 'transform': static. (0x7f3e6b938fd0)
    ...
    //     0x7da188: add             x0, PP, #0x39, lsl #12  ; [pp+0x39578] Closure: (BoxConstraints) => BoxConstraints from Function 'transform': static. (0x7f3e6b938fd0)
