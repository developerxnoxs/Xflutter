...
class AdaptiveTextSelectionToolbar extends StatelessWidget {
  ...
  _ build(/* No info */) {
    ...
    //     0x7f910c: add             x0, PP, #0x22, lsl #12  ; [pp+0x22788] Closure: (BuildContext, Widget) => Widget from Function '_defaultToolbarBuilder@185142888': static. (0x7f3e6bb765dc)
    ...
    //     0x7f9198: add             x0, PP, #0x22, lsl #12  ; [pp+0x22790] Closure: (BuildContext, Offset, Offset, Widget) => Widget from Function '_defaultToolbarBuilder@491408280': static. (0x7f3e6bb4dd5c)
