...
class _RenderSlider extends __RenderRangeSlider&RenderBox&RelayoutWhenSystemFontsChangeMixin {
  ...
  double _maxSliderPartWidth(_RenderSlider) {
    ...
    //     0x53c890: add             x2, PP, #0x30, lsl #12  ; [pp+0x302a8] Closure: (double, double) => double from Function 'max': static. (0x7f3e6b93bc50)
  ...
  double _maxSliderPartHeight(_RenderSlider) {
    ...
    //     0x5527d0: add             x2, PP, #0x30, lsl #12  ; [pp+0x302a8] Closure: (double, double) => double from Function 'max': static. (0x7f3e6b93bc50)
