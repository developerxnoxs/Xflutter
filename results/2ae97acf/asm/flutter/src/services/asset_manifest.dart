...
abstract class AssetManifest extends Object {
  ...
  static _ loadFromAssetBundle(/* No info */) {
    ...
    //     0x941128: add             lr, PP, #0x20, lsl #12  ; [pp+0x20d18] Closure: (ByteData) => _AssetManifestBin from Function '_AssetManifestBin@384287047.fromStandardMessageCodecMessage': static. (0x7f3e6bd415e4)
