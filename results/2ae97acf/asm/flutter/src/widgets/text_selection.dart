...
class SelectionOverlay extends Object {
  ...
  _ showMagnifier(/* No info */) {
    ...
    //     0x468310: ldr             x0, [PP, #0x5110]  ; [pp+0x5110] Closure: (BuildContext, MagnifierController, ValueNotifier<MagnifierInfo>) => Widget? from Function '_none@253282460': static. (0x7f3e6bd6f1e0)
...
class _TextSelectionGestureDetectorState extends State<dynamic> {
  ...
  [closure] LongPressGestureRecognizer <anonymous closure>(dynamic) {
    ...
    //     0x78a900: add             x2, PP, #0x21, lsl #12  ; [pp+0x21e58] Closure: (int) => bool from Function '_defaultButtonAcceptBehavior@60232524': static. (0x7f3e6b9eaff0)
