...
class SwitchAnimationConfig extends Object {
  ...
  get _ hashCode(/* No info */) {
    ...
    //     0x868108: add             x16, PP, #0x26, lsl #12  ; [pp+0x26680] Closure: (Widget, Animation<double>) => Widget from Function 'defaultTransitionBuilder': static. (0x7f3e6ba02c0c)
    ...
    //     0x868130: add             x16, PP, #0x26, lsl #12  ; [pp+0x26688] Closure: (Widget?, List<Widget>) => Widget from Function 'defaultLayoutBuilder': static. (0x7f3e6ba02ae4)
  ...
  _ ==(/* No info */) {
    ...
    //     0x918068: add             x16, PP, #0x26, lsl #12  ; [pp+0x26680] Closure: (Widget, Animation<double>) => Widget from Function 'defaultTransitionBuilder': static. (0x7f3e6ba02c0c)
    ...
    //     0x918070: add             lr, PP, #0x26, lsl #12  ; [pp+0x26680] Closure: (Widget, Animation<double>) => Widget from Function 'defaultTransitionBuilder': static. (0x7f3e6ba02c0c)
    ...
    //     0x918084: add             x16, PP, #0x26, lsl #12  ; [pp+0x26688] Closure: (Widget?, List<Widget>) => Widget from Function 'defaultLayoutBuilder': static. (0x7f3e6ba02ae4)
    //     0x918088: ldr             x16, [x16, #0x688]
    // 0x91808c: r30 = Closure: (Widget?, List<Widget>) => Widget from Function 'defaultLayoutBuilder': static.
    //     0x91808c: add             lr, PP, #0x26, lsl #12  ; [pp+0x26688] Closure: (Widget?, List<Widget>) => Widget from Function 'defaultLayoutBuilder': static. (0x7f3e6ba02ae4)
