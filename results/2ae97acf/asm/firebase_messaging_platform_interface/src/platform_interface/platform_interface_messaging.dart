...
abstract class FirebaseMessagingPlatform extends PlatformInterface {
  ...
  set _ onBackgroundMessage=(/* No info */) {
    ...
    //     0x564470: add             x2, PP, #0x11, lsl #12  ; [pp+0x117a8] Closure: (RemoteMessage) => Future<void> from Function '_firebaseMessagingBackgroundHandler@570043293': static. (0x7f3e6b8d2598)
    ...
    //     0x564494: add             x2, PP, #0x11, lsl #12  ; [pp+0x117a8] Closure: (RemoteMessage) => Future<void> from Function '_firebaseMessagingBackgroundHandler@570043293': static. (0x7f3e6b8d2598)
