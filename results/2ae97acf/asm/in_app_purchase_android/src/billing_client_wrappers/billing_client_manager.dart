...
class BillingClientManager extends Object {
  ...
  _ BillingClientManager(/* No info */) {
    ...
    //     0x400434: ldr             x0, [PP, #0x7548]  ; [pp+0x7548] Closure: ((PurchasesResultWrapper) => void, ((UserChoiceDetailsWrapper) => void)?) => BillingClient from Function '_createBillingClient@765350657': static. (0x7f3e6b7fe540)
