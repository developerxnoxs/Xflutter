...
class XmlDefaultEntityMapping extends XmlEntityMapping {
  ...
  _ encodeAttributeValue(/* No info */) {
    ...
    //     0x95d150: add             x3, PP, #0x3f, lsl #12  ; [pp+0x3f860] Closure: (Match) => String from Function '_singeQuoteAttributeReplace@647209047': static. (0x7f3e6bd5d454)
    ...
    //     0x95d190: add             x3, PP, #0x3f, lsl #12  ; [pp+0x3f870] Closure: (Match) => String from Function '_doubleQuoteAttributeReplace@647209047': static. (0x7f3e6bd5d1b0)
  ...
  _ encodeText(/* No info */) {
    ...
    //     0x95db84: add             x3, PP, #0x3f, lsl #12  ; [pp+0x3f808] Closure: (Match) => String from Function '_textReplace@647209047': static. (0x7f3e6bd5dba4)
