...
class InAppPurchaseAndroidPlatformAddition extends InAppPurchasePlatformAddition {
  ...
  _ InAppPurchaseAndroidPlatformAddition(/* No info */) {
    ...
    //     0x4000cc: ldr             x16, [PP, #0x7500]  ; [pp+0x7500] Closure: (UserChoiceDetailsWrapper) => GooglePlayUserChoiceDetails from Function 'convertToUserChoiceDetails': static. (0x7f3dc780019c)
    // 0x4000d0: str             x16, [SP]
