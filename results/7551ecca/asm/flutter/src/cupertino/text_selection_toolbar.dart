...
class CupertinoTextSelectionToolbar extends StatelessWidget {
  ...
  _ build(/* No info */) {
    ...
    //     0x7f8054: add             x0, PP, #0x22, lsl #12  ; [pp+0x22790] Closure: (BuildContext, Offset, Offset, Widget) => Widget from Function '_defaultToolbarBuilder@491408280': static. (0x7f3dc7b4dd5c)
