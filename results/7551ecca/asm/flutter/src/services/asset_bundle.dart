...
abstract class AssetBundle extends Object {
  ...
  _ loadString(/* No info */) async {
    ...
    //     0x560fe8: add             lr, PP, #0x10, lsl #12  ; [pp+0x105c8] Closure: (ByteData) => String from Function '_utf8decode@383177032': static. (0x7f3dc7961144)
...
abstract class CachingAssetBundle extends AssetBundle {
  ...
  Future<Y0> loadStructuredBinaryData<Y0>(CachingAssetBundle, String, (dynamic, ByteData) => FutureOr<Y0>) {
    ...
    //     0x941270: add             x16, PP, #0x20, lsl #12  ; [pp+0x20d18] Closure: (ByteData) => _AssetManifestBin from Function '_AssetManifestBin@384287047.fromStandardMessageCodecMessage': static. (0x7f3dc7d415e4)
