...
class _HorizontalMarginRenderObject extends RenderShiftedBox {
  ...
  _ computeDryLayout(/* No info */) {
    ...
    //     0x5a10a0: add             x5, PP, #0x23, lsl #12  ; [pp+0x233e8] Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static. (0x7f3dc794dc60)
  ...
  _ _compute(/* No info */) {
    ...
    //     0x5a122c: add             x16, PP, #0x20, lsl #12  ; [pp+0x20fd0] Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static. (0x7f3dc79a13f8)
  ...
  _ performLayout(/* No info */) {
    ...
    //     0x628290: add             x5, PP, #0x20, lsl #12  ; [pp+0x20fd0] Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static. (0x7f3dc79a13f8)
