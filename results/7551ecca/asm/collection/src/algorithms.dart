...
class :: {
  ...
  static void quickSort<Y0>(List<Y0>, (dynamic, Y0, Y0) => int, int, int?) {
    ...
    //     0x4e1148: add             x0, PP, #0x23, lsl #12  ; [pp+0x23c80] Closure: <Y0>(Y0) => Y0 from Function 'identity': static. (0x7f3dc7d71cec)
    ...
    //     0x4e1178: add             x16, PP, #0x23, lsl #12  ; [pp+0x23c80] Closure: <Y0>(Y0) => Y0 from Function 'identity': static. (0x7f3dc7d71cec)
    ...
    //     0x4e11ac: add             x0, PP, #0x23, lsl #12  ; [pp+0x23c80] Closure: <Y0>(Y0) => Y0 from Function 'identity': static. (0x7f3dc7d71cec)
