...
class _TargetSelectionGestureRecognizer extends GestureRecognizer {
  ...
  _ _TargetSelectionGestureRecognizer(/* No info */) {
    ...
    //     0x7f6ac0: add             x0, PP, #0x12, lsl #12  ; [pp+0x12b10] Closure: (int) => bool from Function '_defaultButtonAcceptBehavior@66296176': static. (0x7f8384d661c4)
...
class _CupertinoAlertActionSection extends StatelessWidget {
  ...
  _ build(/* No info */) {
    ...
    //     0x7f778c: add             x1, PP, #0x1d, lsl #12  ; [pp+0x1dcb8] Closure: (ScrollNotification) => bool from Function 'defaultScrollNotificationPredicate': static. (0x7f8384ad759c)
...
class _CupertinoAlertContentSection extends StatelessWidget {
  ...
  _ build(/* No info */) {
    ...
    //     0x7f7240: add             x1, PP, #0x1d, lsl #12  ; [pp+0x1dcb8] Closure: (ScrollNotification) => bool from Function 'defaultScrollNotificationPredicate': static. (0x7f8384ad759c)
