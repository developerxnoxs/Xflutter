...
class :: {
  ...
  static void _debugPrintTask() {
    ...
    //     0x3d8cbc: ldr             x3, [PP, #0xac0]  ; [pp+0xac0] Closure: () => void from Function '_debugPrintTask@46110992': static. (0x7f83847d8e04)
    // 0x3d8cc0: r0 = Timer()
  ...
  static (dynamic, String?, {int? wrapWidth}) => void debugPrint() {
    ...
    //     0x3dde6c: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7f83847d890c)
    // 0x3dde70: ret
    //     0x3dde70: ret             
  }
}
