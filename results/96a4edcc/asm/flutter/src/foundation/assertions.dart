...
class FlutterError extends _FlutterError&Error&DiagnosticableTreeMixin
  ...
  static ((dynamic, FlutterErrorDetails) => void)? onError() {
    ...
    //     0x3d86d8: ldr             x0, [PP, #0x8b8]  ; [pp+0x8b8] Closure: (FlutterErrorDetails, {bool forceReport}) => void from Function 'dumpErrorToConsole': static. (0x7f83847d86f0)
    // 0x3d86dc: LeaveFrame
    //     0x3d86dc: mov             SP, fp
  ...
  static (dynamic, StackTrace) => StackTrace demangleStackTrace() {
    ...
    //     0x3dde64: ldr             x0, [PP, #0x13d0]  ; [pp+0x13d0] Closure: (StackTrace) => StackTrace from Function '_defaultStackTraceDemangler@32022608': static. (0x7f8384d71cec)
    // 0x3dde68: ret
    //     0x3dde68: ret             
  }
  static (dynamic, FlutterErrorDetails) => void presentError() {
    ...
    //     0x3dde74: ldr             x0, [PP, #0x8b8]  ; [pp+0x8b8] Closure: (FlutterErrorDetails, {bool forceReport}) => void from Function 'dumpErrorToConsole': static. (0x7f83847d86f0)
    // 0x3dde78: ret
    //     0x3dde78: ret             
  }
