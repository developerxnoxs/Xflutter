...
abstract class _MaterialPageRoute&PageRoute&MaterialRouteTransitionMixin<X0> extends PageRoute<X0>
  ...
  get _ delegatedTransition(/* No info */) {
    ...
    //     0x951634: add             x0, PP, #0x16, lsl #12  ; [pp+0x16db8] Closure: (BuildContext, Animation<double>, Animation<double>, bool, Widget?) => Widget? from Function '_delegatedTransition@152331911': static. (0x7f8384d51640)
