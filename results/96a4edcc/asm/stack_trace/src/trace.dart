...
class Trace extends Object
  ...
  static _ _parseVM(/* No info */) {
    ...
    //     0x4a5ea4: ldr             x16, [PP, #0x6378]  ; [pp+0x6378] Closure: (String) => Frame from Function 'Frame.parseVM': static. (0x7f83848a6044)
    // 0x4a5ea8: str             x16, [SP]
  ...
  _ toString(/* No info */) {
    ...
    //     0x831a9c: add             x16, PP, #0x14, lsl #12  ; [pp+0x14850] Closure: (int, int) => int from Function 'max': static. (0x7f838493bc50)
