...
class :: {
  ...
  static _ _evaluateBackgroundNotificationCallback(/* No info */) {
    ...
    //     0x4d0198: add             x1, PP, #0xe, lsl #12  ; [pp+0xe368] Closure: (NotificationResponse) => void from Function 'notificationTapBackground': static. (0x7f8384d6f1e0)
    ...
    //     0x4d01a4: add             x1, PP, #0xe, lsl #12  ; [pp+0xe370] Closure: () => void from Function 'callbackDispatcher': static. (0x7f83848d05d4)
