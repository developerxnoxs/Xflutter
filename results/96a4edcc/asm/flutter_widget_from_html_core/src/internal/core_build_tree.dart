...
class _CoreBuildOp extends Object {
  ...
  static _ _newSet(/* No info */) {
    ...
    //     0x6a26b8: add             x1, PP, #0x39, lsl #12  ; [pp+0x394c8] Closure: (_CoreBuildOp, _CoreBuildOp) => int from Function '_compare@1140391556': static. (0x7f8384aa26dc)
...
class CoreBuildTree extends BuildTree {
  ...
  _ _addBitsFromNode(/* No info */) {
    ...
    //     0x6987bc: add             x2, PP, #0x38, lsl #12  ; [pp+0x38d68] Closure: (_CoreBuildOp) => bool from Function '_renderBlock@1140391556': static. (0x7f8384ac7d50)
