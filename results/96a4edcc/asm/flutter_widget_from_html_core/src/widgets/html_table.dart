...
class :: {
  ...
  static _ _extension#0.sum(/* No info */) {
    ...
    //     0x5a4d24: add             x2, PP, #0x3e, lsl #12  ; [pp+0x3eaa0] Closure: (double, double) => double from Function '_extension#0|_sum@1137088161': static. (0x7f8384910f94)
...
class _TableRenderObject extends __TableRenderObject&RenderBox&ContainerRenderObjectMixin&RenderBoxContainerDefaultsMixin {
  ...
  _ computeDryLayout(/* No info */) {
    ...
    //     0x5a3f44: add             x2, PP, #0x23, lsl #12  ; [pp+0x233e8] Closure: (RenderBox, BoxConstraints) => Size from Function 'dryLayoutChild': static. (0x7f838494dc60)
  ...
  _ performLayout(/* No info */) {
    ...
    //     0x6361f4: add             x2, PP, #0x20, lsl #12  ; [pp+0x20fd0] Closure: (RenderBox, BoxConstraints) => Size from Function 'layoutChild': static. (0x7f83849a13f8)
