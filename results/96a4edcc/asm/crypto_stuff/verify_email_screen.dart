...
class _VerifyEmailScreenState extends State<dynamic> {
  ...
  [closure] TextField <anonymous closure>(dynamic, BuildContext, Widget?) {
    ...
    //     0x723d54: add             x2, PP, #0x12, lsl #12  ; [pp+0x124c8] Closure: (BuildContext, EditableTextState) => Widget from Function '_defaultContextMenuBuilder@181181401': static. (0x7f838497fc10)
  ...
  _ requestVerifyAccount(/* No info */) async {
    ...
    //     0x724414: ldr             x0, [PP, #0x13d8]  ; [pp+0x13d8] Closure: (String?, {int? wrapWidth}) => void from Function 'debugPrintThrottled': static. (0x7f83847d890c)
  ...
  [closure] TextField <anonymous closure>(dynamic, BuildContext, Widget?) {
    ...
    //     0x7251a0: add             x2, PP, #0x12, lsl #12  ; [pp+0x124c8] Closure: (BuildContext, EditableTextState) => Widget from Function '_defaultContextMenuBuilder@181181401': static. (0x7f838497fc10)
